                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="header-title">
                            ...
                            <p class="mb-0 text-muted">{{ $sku->nama }} -
                        ...
                        <div class="d-flex gap-2">
                            ...
                            @if ($suratTerbit)
                                <a href="{{ route('sku.print', $sku->id) }}" class="btn btn-primary" target="_blank">
                                ...
                                <div class="content-surat">
                                    ...
                                    <div class="data-table">
                                        ...
                                        <div class="data-row">
                                            ...
                                            <div class="data-separator">:</div>
                                            <div class="data-value">{{ $sku->status_perkawinan }}</div>
                                        </div>
                                        <div class="data-row">
                                    ...
                                    <p>
                                        ...
                                        benar mempunyai/menjalankan usaha <span
                                            class="dot-line">{{ $sku->jenis_usaha ?? '.........................' }}</span>
                                        seluas ±
                                        <span class="dot-line">{{ $sku->luas_usaha ?? '..........' }}</span> Ha di Jorong
                                        <span class="dot-line">{{ $sku->alamat ?? '....................' }}</span> Nagari
                                        Koto Alam Kecamatan
                                        Pangkalan Koto Baru Kabupaten Lima Puluh Kota.
                                    </p>

                                    <p>
                                        Demikian Surat Keterangan Usaha ini kami buat dengan sebenarnya untuk dapat
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-sm table-borderless">
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                @switch($sku->permintaanSurat->status)
                                                    @case('Diproses')
                                                        <span class="badge bg-warning">{{ $sku->permintaanSurat->status }}</span>
                                                    @break

                                                    @case('Diterima')
                                                        <span class="badge bg-success">{{ $sku->permintaanSurat->status }}</span>
                                                    @break

                                                    @case('Ditolak')
                                                        <span class="badge bg-danger">{{ $sku->permintaanSurat->status }}</span>
                                                    @break

                                                    @default
                                                        <span class="badge bg-secondary">{{ $sku->permintaanSurat->status }}</span>
                                                @endswitch
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            @php
                                                \Carbon\Carbon::setLocale('id');
                                            @endphp
                                            <td>{{ \Carbon\Carbon::parse($sku->permintaanSurat->tanggal_permintaan)->translatedformat('d F Y') }}
                                            </td>
                                        </tr>
                                        @if ($suratTerbit)
                                            <tr>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <table class="table table-sm table-borderless">
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>{{ $sku->permintaanSurat->verifikasiPengguna->nama_lengkap }}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>Jenis Surat</td>
                                            <td>:</td>
                                            <td>{{ $sku->permintaanSurat->jenisSurat->nama_surat ?? 'SKU' }}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
