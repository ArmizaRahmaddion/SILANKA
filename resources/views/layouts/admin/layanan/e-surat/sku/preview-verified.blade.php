                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="preview-container"
                            ...
                            <div class="text-center mb-4">
                                <h5 class="fw-bold text-decoration-underline">
                                    @if ($verifikasi->jenisSurat->kode_surat === 'SKU')
                            ...
                            @if ($verifikasi->jenisSurat->kode_surat === 'SKU' && $suratTerbit)
                                <!-- Content Surat -->
                        ...
                        <div class="text-center mt-4">
                            @if ($verifikasi->jenisSurat->kode_surat === 'sku' && $sku)
                                <a href="{{ route('sku.print', $sku->id) }}" class="btn btn-primary me-2" target="_blank">
