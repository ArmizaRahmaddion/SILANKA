@extends('layouts.dashboard-layouts', ['title' => 'Surat Keterangan Domisili'])
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex gap-1">
                                            @if ($suratTerbit && in_array($status, ['Diterima', 'Selesai']))
                                                <a href="{{ route('skd.print', $datasurat->id) }}"
                                                    class="btn btn-sm btn-info" title="Cetak Surat" target="_blank">
                                                    <i class="ri-printer-fill"></i>
                                                </a>
                                                <a href="{{ route('surat.skd.preview', $datasurat->id) }}"
                                            ...
                                            @hasanyrole('staff-tu|superadmin')
                                                    ...
                                                    <div class="modal fade" id="modalEditSurat{{ $datasurat->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-lg modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <form action="{{ route('surat.skd.update', $datasurat->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title"
                                                                            ...
                                                                            Edit Surat Keterangan Domisili
                                                                            @if ($suratTerbit)
                                                                                <span
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <label for="alamat"
                                                                                class="form-label">Alamat<span
                                                                                    class="text-danger">*</span></label>
                                                                            <textarea name="alamat" class="form-control" rows="2" required>{{ $datasurat->alamat }}</textarea>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <label for="pekerjaan"
                                                ...
                                                @if ($status === 'Diterima' && !$sudahDiajukan && $suratTerbit)
                                                    @php
                                                        $kodeSurat =
