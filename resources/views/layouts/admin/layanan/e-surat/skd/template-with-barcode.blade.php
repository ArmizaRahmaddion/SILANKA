...
<head>
    <meta charset="UTF-8" />
    <title>SKD - Surat Keterangan DOMISILI</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <p>
            ...
            Pangkalan Koto Baru Kabupaten Lima Puluh Kota menerangkan bahwa nama yang tersebut dibawah ini:
        </p>
        ...
        <p>
            Sepanjang dalam pengetahuan kami dan berdasarkan laporan dari yang bersangkutan, bahwa benar yang
            bersangkutan diatas tinggal/ berdomisili di Jorong <span class="dot-line">{{ $skd->alamat }}</span> Nagari
            Koto
