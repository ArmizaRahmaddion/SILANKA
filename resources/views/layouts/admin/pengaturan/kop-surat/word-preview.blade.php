...
<head>
    ...
    <title>{{ $kopSurat->nama_instansi }} - Preview Word</title>
    <style>
        @page {
            size: A4;
...
<body>
    ...
    <div class="no-print">
        ...
        <a href="{{ route('kop-surat.show', $kopSurat) }}" class="btn btn-secondary">
    ...
    <div class="page">
        ...
        <div class="kop-header">
            ...
            <div class="header-text">
                <div class="instansi-1">{{ $kopSurat->nama_instansi }}</div>

                @if ($kopSurat->nama_instansi_2)
                    <div class="instansi-2">{{ $kopSurat->nama_instansi_2 }}</div>
                @endif

                @if ($kopSurat->nama_instansi_3)
                    <div class="instansi-3">{{ $kopSurat->nama_instansi_3 }}</div>
                @endif
        ...
        <div class="surat-title">
            <h1>{{ $jenisSurat ?? 'SURAT KETERANGAN TIDAK MAMPU' }}</h1>
            <div class="nomor-surat">NOMOR: {{ $nomor ?? '.../SKTM/WN-KA/' . date('Y') }}</div>
        </div>
