...
@section('content')
                ...
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-lg-10">
                        ...
                        <p class="text-white-50 mb-0 fs-5">
                            Lengkapi data di bawah ini untuk mengajukan surat keterangan Usaha
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- Modern Form Section -->
    <section id="form-sku" class="py-5 bg-light">
        <div class="container">
            <!-- Main Form Card -->
                ...
                <div class="col-lg-10">
                    <div class="card shadow border-0 rounded-3">
                        ...
                        <div class="card-body p-4">
                            <form action="{{ Route('sku.store') }}" method="POST" id="skuForm">
                                @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="keperluan" id="keperluan" class="form-control"
                                                    placeholder="Contoh: Syarat pengajuan kredit bank" required
                                                    value="{{ old('keperluan') }}">
                                                <label for="keperluan">
                                ...
                                <div class="form-section mb-5">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="jenis_usaha" id="jenis_usaha"
                                                    class="form-control"
                                                    placeholder="Contoh: Warung Kelontong, Bengkel, dll" required
                                                    value="{{ old('jenis_usaha') }}">
                                                <label for="jenis_usaha">
                                                    <i class="bi bi-shop-window me-2"></i>Jenis Usaha *
                                                </label>
                                                <div class="form-text">
                                                    <small class="text-muted">
                                                        <i class="bi bi-lightbulb me-1"></i>
                                                        Contoh: Warung Kelontong, Bengkel Motor, Toko Pakaian
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3">
                                                <input type="text" name="luas_usaha" id="luas_usaha"
                                                    class="form-control" placeholder="Contoh: 0.5" required
                                                    value="{{ old('luas_usaha') }}">
                                                <label for="luas_usaha">
                                                    <i class="bi bi-rulers me-2"></i>Luas Usaha (Hektar) *
                                                </label>
                                                <div class="form-text">
                                                    <small class="text-muted">
                                                        <i class="bi bi-info-circle me-1"></i>
                                                        Masukkan dalam satuan hektar (Ha). Contoh: 0.5 Ha
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
