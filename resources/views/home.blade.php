@extends('layouts.dashboard-layouts', ['title' => 'Dashboard'])
                        ...
                        <div class="card-body">
                            <div class="progress-widget">
                                <div id="circle-progress-01"
                                    ...
                                    data-min-value="0" data-max-value="{{ $totalUsers + 100 }}"
                                    data-value="{{ $totalUsers }}" data-type="percent">
                        ...
                        <div class="card-body">
                            <div class="progress-widget">
                                <div id="circle-progress-02"
                                    ...
                                    data-min-value="0" data-max-value="{{ $totalPengaduan + 100 }}"
                                    data-value="{{ $totalPengaduan }}" data-type="percent">
                                    <svg class="card-slie-arrow icon-24" width="24" viewBox="0 0 24 24">
                                ...
                                <div class="progress-detail">
                                    ...
                                    <h4 class="counter">{{ $totalPengaduan }}</h4>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="card-body">
                            <div class="progress-widget">
                                <div id="circle-progress-03"
                                    class="text-center circle-progress-01 circle-progress circle-progress-primary"
                                    data-min-value="0" data-max-value="{{ $totalPerangkatNagari + 100 }}"
                                    data-value="{{ $totalPerangkatNagari }}" data-type="percent">
                                    <svg class="card-slie-arrow icon-24" width="24" viewBox="0 0 24 24">
                                        <path fill="currentColor" d="M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z" />
                                    </svg>
                                </div>
                                <div class="progress-detail">
                                    <p class="mb-2">Perangkat Nagari</p>
                                    <h4 class="counter">{{ $totalPerangkatNagari }}</h4>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="card-body">
                            <div class="progress-widget">
                                <div id="circle-progress-04"
                                    class="text-center circle-progress-01 circle-progress circle-progress-info"
                                    data-min-value="0" data-max-value="{{ $totalPermintaanSuratHariIni + 100 }}"
                                    data-value="{{ $totalPermintaanSuratHariIni }}" data-type="percent">
                                    <svg class="card-slie-arrow icon-24" width="24px" viewBox="0 0 24 24">
                                        <path fill="currentColor" d="M5,17.59L15.59,7H9V5H19V15H17V8.41L6.41,19L5,17.59Z" />
                                    </svg>
                                </div>
                                <div class="progress-detail">
                                    <p class="mb-2 small">Permintaan Surat</p>
                                    <h4 class="counter">{{ $totalPermintaanSuratHariIni }} Hari ini</h4>
                                </div>
                            </div>
                        </div>
                    </li>
